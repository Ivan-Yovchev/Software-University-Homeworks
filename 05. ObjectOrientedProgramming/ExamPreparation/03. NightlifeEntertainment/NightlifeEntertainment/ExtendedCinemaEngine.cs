namespace NightlifeEntertainment
{
    ...
    public class ExtendedCinemaEngine : CinemaEngine
    {
        protected override void ExecuteReportCommand(string[] commandWords)
        {
            ...
            this
                .Output
                .AppendFormat("{0}: {1} ticket(s), total: ${2:F2}", performance.Name, soldTickets.Count(), soldTickets.Sum(t => t.Price))
                .AppendLine()
                .AppendFormat("Venue: {0} ({1})", performance.Venue.Name, performance.Venue.Location)
                .AppendLine()
                .AppendFormat("Start time: {0:MM/dd/yyyy H:mm:ss}", performance.StartTime)
                .AppendLine();
        }
