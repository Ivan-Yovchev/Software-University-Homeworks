...
{
    class DirectoryContentsMain
    {
        static void Main()
        {
            var directoryXml = new XElement("root-dir",
            ...
            new XElement("dir",
                ...
                new XElement("dir",
                    ...
                    new XElement("file",
                        new XAttribute("name", "baloons.jpg"))),
                new XElement("dir",
                    new XAttribute("name", "travel"),
                    new XElement("file",
                        new XAttribute("name", "IMG24152.jpg")))
            )
        );
            Console.WriteLine(directoryXml);

            directoryXml.Save("../../directory.xml");  
        }
    }
}
