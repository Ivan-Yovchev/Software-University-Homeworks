...
{
    class TicketOfficeMain
    {
        public static ITicketRepository ticketRepository = new TicketRepository();
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    string commandResult = ProccessCommand(line);
                    Console.WriteLine(commandResult);
                }
            }
        }

        private static string ProccessCommand(string line)
        {
